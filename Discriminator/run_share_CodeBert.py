...
def eval_acc_epoch(args, eval_data, eval_examples, codebert, model, loss_fn):
...
def main():
    ...
    config_class, model_class, tokenizer_class = MODEL_CLASSES['codebert']
    ...
    if args.do_train:
        ...
        for cur_epoch in range(int(args.num_train_epochs)):
            ...
            if args.do_eval and (int(cur_epoch) % 1 == 0):
                ...
                eval_loss, eval_acc = eval_acc_epoch(args, eval_data, eval_examples, codebert, model, loss_fn)
